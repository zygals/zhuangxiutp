...
class Shop extends Base{
	...
	public static function read($data){
		...
		$row_ = self::getById( $shop_id , new self() , 'id shop_id,name,city,addr,truename,phone,ordernum,tradenum,fankuinum,img,logo,info,brand,zuoji,deposit,youhui,money_all,youhui_all,qrcode' );
