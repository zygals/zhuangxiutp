...
class ActivityAttend extends Base {
    ...
    public static function getList($data=[]) {
        ...
        $list_ = self::where($where)->join('activity','activity.id=activity_attend.activity_id','left')->field('activity_attend.*,activity.name activity_name')->order($order)->paginate();
