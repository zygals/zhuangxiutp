...
<div role="tabpanel" class="tab-pane" id="user" style="display:block;">
	<div class="check-div form-inline row">
				<div class="col-xs-2">
                    <a href="{:url('create')}"><button class="btn btn-yellow btn-xs" data-toggle="modal" data-target="#addUser" id="create">添加商户</button></a>
		</div>
        <div class="col-xs-10">
              ...
              <!--  <div class="col-xs-1" title=" {$row_->create_time}">
				...
				<div class="col-xs-">
                    <?php if(empty($row_->admin_id)){?>
                        <a href="{:url('admin/create')}?shop_id={$row_->id}"><button class="btn btn-success btn-xs edit_" >加管</button></a>
                    <?php }else{?>
